...
select shipping_type, avg(purchase_amount) as round from customer where shipping_type in ('standard','express')
group by shipping_type;

-- Q5: Do Subscribed customers spend more? compare average spend and total revenue between subscribed and non-subscriber
...
-- Q9: Are customers who aare repeat buyers (more than 5 previous purchase) also likely to subscribe?
...
-- Q10: What is revenue contribution of wach age group?
select age_group,
